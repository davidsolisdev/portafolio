      ...
      <article data-aos="zoom-in-down">
        <TimeLine>
          <ItemTimeLine
            ...
            fecha="Noviembre 2022 - Hoy en día"
          >
            ...
            dandole la oportunidad de publicar inmediatamente las alertas de
            desaparición.
          </ItemTimeLine>
          <ItemTimeLine
            title="Guía de practicantes universitarios en la empresa que laboro"
            fecha="Octubre 2022 - Hoy en día"
          >
            Actualmente, aparte de mis labores como desarrollador también
            superviso e instruyo a los practicantes universitarios que se han
            aceptado en la empresa en la que actualmente laboro.
          </ItemTimeLine>

          <ItemTimeLine
            title="Aplicación móvil ejecución de logística, planificación y despachos"
            fecha="Junio 2022 - Octubre 2022"
          >
            Aplicación para uso interno de la empresa en la que laboro, la cual
            funciona para hacer el conteo de cajas de producto a enviar a través
            de códigos QR, asignación de diferentes tareas como conteos de
            productos, empaque y reempaque de productos, seguimiento de rutas de
          ...
          <ItemTimeLine
            ...
            fecha="Agosto 2021 - Octubre 2021"
          >
